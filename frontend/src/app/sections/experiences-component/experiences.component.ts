...
export class ExperiencesComponent {
  protected readonly entries: ExperienceEntry[] = [
    ...
    },
    {
      ...
      descriptionKeys: [
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_1',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_2',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_3',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_4',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_5',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_6',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_7',
        ...
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_12',
        'EXPERIENCE_CESLA_FULLSTACK_RESPONSIBILITY_13',
      ],
