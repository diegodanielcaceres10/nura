  ...
  projects = signal<ProjectCard[]>([
    {
      ...
      kpis: [
        { value: '3', legend: 'PROJECT_NURA_KPI_1', icon: 'fa-solid fa-globe' },
        { value: '11', legend: 'PROJECT_NURA_KPI_2', icon: 'fa-solid fa-flask' },
        { value: '100%', legend: 'PROJECT_NURA_KPI_3', icon: 'fa-solid fa-chart-pie' },
      ],
    ...
    },
    {
      ...
      kpis: [
        { value: '+10', legend: 'PROJECT_OCTOAUTODRIVE_KPI_1', icon: 'fa-solid fa-cube' },
        { value: '3', legend: 'PROJECT_OCTOAUTODRIVE_KPI_2', icon: 'fa-solid fa-gear' },
        { value: '3', legend: 'PROJECT_OCTOAUTODRIVE_KPI_3', icon: 'fa-solid fa-globe' },
      ],
    ...
    },
    {
      ...
      kpis: [
        { value: '4', legend: 'PROJECT_OILGROUP_KPI_1', icon: 'fa-solid fa-rocket' },
        { value: '+8', legend: 'PROJECT_OILGROUP_KPI_2', icon: 'fa-solid fa-cube' },
      ],
    ...
    },
    {
      ...
      kpis: [
        { value: 'v1.4.6', legend: 'PROJECT_ANGULARJSONFORM_KPI_1', icon: 'fa-solid fa-code-branch' },
        { value: '15', legend: 'PROJECT_ANGULARJSONFORM_KPI_2', icon: 'fa-brands fa-buffer' },
      ],
