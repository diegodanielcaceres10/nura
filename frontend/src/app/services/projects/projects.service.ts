  ...
  private readonly projects: ProjectItem[] = [
    {
      ...
      techStackFull: [
        ...
        { category: 'Datos', items: ['PostgreSQL', 'Prisma ORM', 'Migrations'] },
        { category: 'Autenticación', items: ['JWT', 'Google OAuth', 'Access & Refresh Tokens'] },
    ...
    },
    {
      ...
      techStackFull: [
        ...
        { category: 'DevOps', items: ['Docker', 'Docker Compose', 'GitHub Actions', 'GitHub Pages'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 20', 'Ionic 8', 'TypeScript', 'Leaflet'] },
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 21', 'TypeScript', 'Angular Material', 'Angular CDK', 'RxJS', 'Angular Signals', 'Reactive Forms'] },
        { category: 'Testing', items: ['Vitest (93 tests, ~94% cobertura)'] },
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 21', 'TypeScript', 'SCSS', 'Angular Router', 'i18n propio (EN, ES, PT)'] },
        { category: 'Testing', items: ['Vitest (unit)', 'Cypress (e2e)'] },
        { category: 'Calidad y CI/CD', items: ['ESLint', 'Prettier', 'Lighthouse CI (desktop + mobile)', 'GitHub Actions'] },
        { category: 'DevOps', items: ['Docker (entorno de desarrollo)'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        ...
        { category: 'Backend', items: ['Node.js', 'Express', 'JWT (auth)', 'Rate limiting'] },
        { category: 'Datos e integraciones', items: ['MySQL', 'Cloudinary (assets)', 'Google APIs', 'Nodemailer (emails)', 'PDF Creator (reportes)'] },
        { category: 'DevOps', items: ['Multi-entorno (dev/qua/hom/prd)'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Librería', items: ['Angular (ng-package / Angular Library)', 'TypeScript', 'tslib'] },
        { category: 'App de demo incluida', items: ['Angular app (json-form-app)'] },
        { category: 'Testing', items: ['Karma'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 13', 'TypeScript', 'ngx-translate (i18n)', 'Chart.js', 'angular-json-form', 'Socket.IO Client'] },
        { category: 'Backend', items: ['Node.js', 'Express', 'Socket.IO', 'JWT (auth)', 'i18n', 'Rate limiting'] },
        { category: 'Datos e integraciones', items: ['MySQL', 'Cloudinary (assets)', 'Google APIs', 'Facebook API', 'Nodemailer (emails)'] },
        { category: 'DevOps', items: ['Forever', 'Multi-env (prod/dev/cloud)'] },
        { category: 'Testing', items: ['Karma + Jasmine'] },
      ],
