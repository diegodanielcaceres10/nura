  ...
  private readonly projects: ProjectItem[] = [
    {
      ...
      status: 'COMPLETED',
      year: 2026,
      fullDescription: 'PROJECTS_CARD_LUMA_FULL_DESC',
      techStackFull: [
        { category: 'App', items: ['Flutter', 'Supabase', 'Google Auth', 'PDF Export'] },
        { category: 'Backend', items: ['Supabase', 'Google Gemini API'] },
        { category: 'BD', items: ['PostgreSQL'] },
        { category: 'Landing Page', items: ['Angular 21 (SSR)', 'TailwindCSS 4'] },
        { category: 'DevOps', items: ['Docker', 'Firebase App Distribution', 'GitHub Actions', 'GitHub Pages'] },
      ],
      keyFeatures: ['PROJECTS_CARD_LUMA_FEATURE_1', 'PROJECTS_CARD_LUMA_FEATURE_2', 'PROJECTS_CARD_LUMA_FEATURE_3', 'PROJECTS_CARD_LUMA_FEATURE_4', 'PROJECTS_CARD_LUMA_FEATURE_5', 'PROJECTS_CARD_LUMA_FEATURE_6', 'PROJECTS_CARD_LUMA_FEATURE_7'],
      challenges: ['PROJECTS_CARD_LUMA_CHALLENGE_1', 'PROJECTS_CARD_LUMA_CHALLENGE_2', 'PROJECTS_CARD_LUMA_CHALLENGE_3'],
      gallery: ['assets/projects/luma/screen-login.png', 'assets/projects/luma/screen-home.png', 'assets/projects/luma/screen-transactions.png', 'assets/projects/luma/screen-charts.png', 'assets/projects/luma/screen-accounts.png', 'assets/projects/luma/screen-categories.png'],
      links: {
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Backend', items: ['Node.js', 'Express', 'TypeScript', 'REST API'] },
        { category: 'DB', items: ['PostgreSQL', 'Prisma ORM', 'Migrations'] },
        { category: 'Auth', items: ['JWT', 'Google OAuth'] },
        { category: 'Email', items: ['Brevo', 'Resend', 'Transactional Email', 'HTML Templates', 'i18n'] },
      ],
    ...
    },
    {
      ...
      coverImage: '',
      techStackPreview: ['React', 'TypeScript', 'Docker'],
      status: 'IN_PROGRESS',
      year: 2026,
      fullDescription: 'PROJECTS_CARD_KORA_ROSTER_FULL_DESC',
      techStackFull: [
        { category: 'Frontend', items: ['React', 'TypeScript'] },
        { category: 'DevOps', items: ['Docker', 'GitHub Actions', 'GitHub Pages'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 20', 'Ionic 8', 'TypeScript'] },
        { category: 'DevOps', items: ['Docker (build APK)'] },
        { category: 'Testing', items: ['Karma + Jasmine'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 21', 'TypeScript', 'Angular Material', 'RxJS', 'Reactive Forms'] },
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 21', 'TypeScript', 'SCSS', 'Angular Router', 'i18n (EN, ES, PT)'] },
        { category: 'Testing', items: ['Vitest', 'Cypress'] },
        { category: 'DevOps', items: ['Docker', 'Lighthouse CI (desktop + mobile)', 'GitHub Actions', 'GitHub Pages'] },
      ],
    ...
    },
    {
      ...
      techStackPreview: ['Angular 11', 'Node.js', 'Express', 'MySQL'],
      status: 'COMPLETED',
      year: 2024,
      fullDescription: 'PROJECTS_CARD_OILGROUP_FULL_DESC',
      techStackFull: [
        { category: 'Frontend', items: ['Angular 11', 'TypeScript', 'amCharts 4', 'RxJS'] },
        { category: 'Backend', items: ['Node.js', 'Express'] },
        { category: 'DB', items: ['MySQL', 'Cloudinary', 'Google APIs', 'Nodemailer', 'PDF Creator'] },
        { category: 'DevOps', items: ['Multi-env (dev/qua/hom/prd)'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Lib', items: ['Angular', 'TypeScript'] },
        { category: 'Demo', items: ['Angular Web'] },
      ],
    ...
    },
    {
      ...
      techStackFull: [
        { category: 'Frontend', items: ['Angular 13', 'TypeScript', 'i18n', 'Chart.js', 'Socket.IO'] },
        { category: 'Backend', items: ['Node.js', 'Express', 'Socket.IO', 'JWT (auth)'] },
        { category: 'DB', items: ['MySQL', 'Cloudinary', 'Google APIs', 'Facebook API', 'Nodemailer'] },
        { category: 'DevOps', items: ['Forever', 'Multi-env (dev/qua/hom/prd)'] },
      ],
